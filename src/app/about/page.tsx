          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="w-full md:w-1/2 md:pl-10">
                ...
                <p className="mb-4 text-gray-700">Welcome to K.P. Power Electrical Services. Founded in 2022, we have been providing top-quality electrical solutions for residential and commercial clients in Tucson, Arizona and surrounding areas within a 50-mile radius.</p>
                <p className="text-gray-700">Our owner, Kyle, brings 10 years of experience to every project. His passion for electrical work and commitment to customer satisfaction are the driving forces behind our company's success.</p>
              </div>
            </motion.div>
          </div>
        </section>
